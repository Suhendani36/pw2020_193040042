    ...
    <div class="container" style="text-align: center; margin-top: 20px;">
      <div class="row">
        <div class="col">
          ...
          <button type="submit" name="tambah" class="btn btn-info tombol">Tambah Data</button>
        </div>
      </div>
    </div>
    <div class="container">
      ...
      <div class="row add">
        <div class="col-sm coll">
          <div class="img">
            <label class="ml-4 mt-2">
              <b>Gambar</b>
              <img src="../assets/img/nophoto.png" width="100" style="display: block;" class="img-preview">
        ...
        <div class="col-lg">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <textarea class="form-control" id="bahan" rows="4" name="bahan"></textarea>
            </div>
          </div>
          <div class="form-group row">
            <label for="daerah_asal" class="col-sm-2 col-form-label "><b>Daerah Asal</b></label>
            <div class="col-sm-9">
              <input type="text" name="daerah_asal" class="form-control" id="daerah_asal" required value="">
            </div>
          </div>
          <div class="form-group row">
            <label for="manfaat" class="col-sm-2 col-form-label "><b>Manfaat Makanan</b></label>
            <div class="col-sm-9">
              <textarea class="form-control" id="manfaat" rows="4" name="manfaat"></textarea>
            </div>
          </div>
        </div>
      </div>
